...
2. Gather the candidate issue set.
...
3. Shortlist false positives and false negatives.
...
4. Choose exactly five actionable issues when possible.
...
5. Reproduce each issue before editing.
...
8. Fuzz each touched rule for additional false positives.
...
9. Write the pull request description without opening a pull request.
